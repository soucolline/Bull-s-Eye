//
//  LaderboardTableViewController.swift
//  Bull's Eye
//
//  Created by Thomas Guilleminot on 11/06/16.
...
class LaderboardTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.topItem?.title = "Laderboard";
